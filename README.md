...
10,45(십진수),0b1010(이진수 1010),

020(8진수 20), 0x1d(16진수 1d)
...
줄의 내용을 모두 읽어 문자열로 반환

boolean nextBoolean()

논리 값을 읽어 boolean으로 반환

int nextInt(int radix)

long nextLong(int radix)

정수를 인자인 radix 진법으로 읽어 변환
